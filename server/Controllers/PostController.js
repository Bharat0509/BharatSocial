...
export const getPost = async (req, res) => {
    ...
    console.log("Post Id in params ", req.params);
...
export const deletePost = catchAsyncError(async (req, res, next) => {
    ...
    if (!post)
        return next(new ErrorHandler("Post Doen Not Exist With Given Id", 404));
...
export const getTimeLinePosts = async (req, res, next) => {
    ...
    try {
        ...
        console.log("Following User-->", followingPosts[0].followingPosts);
        ...
        return next(
            new ErrorHandler(`Error :${error?.response?.data?.message}`, 500)
        );
    }
};
